...
df_out.to_csv('/Users/ericliao/Desktop/metabolomics_workbench_studies/PR000058/ST000061_ST000065/results/SubcutaenousFat_vs_VisceralFat_vip_gretaer_0.csv')
######################################################
...
plot_2d.plsda_2d_plot(scores, target_color, target_names, 2, 'PLS-DA for Subcutaenous Fat, Visceral Fat')
