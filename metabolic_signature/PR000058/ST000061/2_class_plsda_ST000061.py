...
### load data
df = pd.read_csv('/Users/ericliao/Desktop/metabolomics_workbench_studies/ST000061/data/aligned.csv')
df_factor = pd.read_csv('/Users/ericliao/Desktop/metabolomics_workbench_studies/ST000061/data/factors.csv')
...
for index, row in df_height_transposed.iterrows():
    ...
    label = df_factor[df_factor['local_sample_id'] == local_sample_id]['Source'].values[0]
...
df_out.to_csv('/Users/ericliao/Desktop/metabolomics_workbench_studies/ST000061/results/SubcutaenousFat_vs_VisceralFat_vip_gretaer_0.csv')
######################################################
...
### plot plsda
target_names = ['Subcutaenous Fat Q2: ' + str("%.2f" % q2[0]), 'Visceral Fat Q2' + ": " + str("%.2f" % q2[1])]
target_names = np.array(target_names)

plot_2d.plsda_2d_plot(scores, target, target_names, 2, 'PLS-DA for Subcutaenous Fat vs Visceral Fat')
