...
### load data
df = pd.read_csv('/Users/ericliao/Desktop/metabolomics_workbench_studies/ST000145/data/aligned.csv')
df_factor = pd.read_csv('/Users/ericliao/Desktop/metabolomics_workbench_studies/ST000145/data/factors.csv')
...
for index, row in df_height_transposed.iterrows():
    ...
    if operator.contains(label, "Glucose"):
        target.append(0)
        df_new = df_new.append(row)
    if operator.contains(label, "Glutamine"):
        target.append(1)
        df_new = df_new.append(row)
...
df_out.to_csv('/Users/ericliao/Desktop/metabolomics_workbench_studies/ST000145/results/deprive_glucose_vs_deprive_glutamine_vip_gretaer_0.csv')
######################################################
...
### plot plsda
target_names = ['glucose: ' + str("%.2f" % q2[0]), 'glutamine' + ": " + str("%.2f" % q2[1])]
target_names = np.array(target_names)

plot_2d.plsda_2d_plot(scores, target, target_names, 2, 'PLS-DA for Deprive of Glucose verse Deprive of Glutamine')
