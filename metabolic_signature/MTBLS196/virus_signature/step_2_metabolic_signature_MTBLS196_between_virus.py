...
testing_data_top10.to_csv(
    "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_virus/with_feature_selection/test_data_20_percent_trachea_virus.csv"
)
training_data_top10.to_csv(
    "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_virus/with_feature_selection/train_data_80_percent_trachea_virus.csv"
)


#### train the PLS-DA model with training data
plsr = pls_da_model.pls_da(
    training_data_top10.iloc[:, :-1],
    np.array(training_data_top10.iloc[:, -1].tolist()),
    0,
)
...
df_out_with_vips.to_csv(
    "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_virus/with_feature_selection/vips_trachea_virus.csv"
)
...
df_match = pd.read_csv(
    "/Lab_work/data_files/metabolic_signature/MTBLS196/Neg/matched.csv",
    header=0,
    index_col=None,
)
...
df_out_annotated_with_vip.to_csv(
    "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_virus/with_feature_selection/vips_annotated_trachea_virus.csv"
)
...
df_top10_vip_matches.to_csv(
    "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_virus/with_feature_selection/vips_top10_annotated_trachea_virus.csv"
)
...
######################################################
#
# df_top10_vip_matches = pd.read_csv("/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature"
#                                    "/MTBLS196/Neg/between_different_organisms/with_feature_selection/vips_top10_annotated_organism.csv")
# testing_data_top10 = pd.read_csv(
#     "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_different_organisms/with_feature_selection/test_data_20_percent_organism.csv"
# )
# training_data_top10 = pd.read_csv(
#     "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_different_organisms/with_feature_selection/train_data_80_percent_organism.csv"
# )
# df_factor = pd.read_csv(
#     "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/MTBLS196_neg_factors.csv"
# )
...
for i in training_data_top10.index:
    virus_type = df_factor[df_factor["Sample Name"] == i]["virus"].values[0]
    if operator.contains(virus_type, "1918"):
        target_train_top10.append(0)

    if operator.contains(virus_type, "Cal04RG"):
...
target_names = [
    "1918 trachea: " + str("%.2f" % q2[0]),
    "Cal04RG trachea: " + str("%.2f" % q2[0]),
]
