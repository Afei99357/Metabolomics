...
### read in data
df = pd.read_csv("/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/aligned.csv")
...
df_out_with_vips.to_csv(
    "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_different_organisms/with_feature_selection/vips_organism.csv"
)
...
df_match = pd.read_csv(
    "/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/matched.csv",
    header=0,
    index_col=None,
)
...
df_out_annotated_with_vip.to_csv(
    "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_different_organisms/with_feature_selection/vips_annotated_organism.csv"
)
...
df_top10_vip_matches.to_csv(
    "/Users/yliao13/PycharmProjects/phd_class/Lab_work/data_files/metabolomics_signature/MTBLS196/Neg/between_different_organisms/with_feature_selection/vips_top10_annotated_organism.csv"
)
...
for i in training_data_top10.index:
    organism_part = df_factor[df_factor["Sample Name"] == i]["organism_part"].values[0]
